...
บ                             Bob Ray Tracer                              บ
บ                                                                         บ
บ         Pic.C = file output routines for creating files compatible      บ
บ		 with Bob's run length encoding.  The paranoid mode       บ
บ		 operation forces the program to close the output file    บ
บ		 every TIME_OUT seconds.  This ensures that in case of    บ
บ		 a power outage you will at most loose the 60 seconds     บ
บ		 of work or the current scan line, whichever is greater.  บ
บ                                                                         บ
...
บ                                                                         บ
บ    		    Requires: pic.h, defs.h, extern.h                     บ
บ                                                                         บ
