...
บ                             Bob Ray Tracer                              บ
บ                                                                         บ
บ                Screen.C = screen scanning and anti-aliasing		  บ
บ                                                                         บ
...
บ                                                                         บ
บ                    Requires: defs.h, pic.h, extern.h                    บ
บ                                                                         บ
...
void	Screen(view, picfile, xres, yres)
	Viewpoint	*view;
	char		*picfile;
	int		xres, yres;
{
...
void	ScrInit(view, xres, yres, picfile)
	Viewpoint	*view;
	int		xres, yres;
	char		*picfile;
{
