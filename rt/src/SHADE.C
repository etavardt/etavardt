...
บ                             Bob Ray Tracer                              บ
บ                                                                         บ
บ       Shade.C = Given the intersection point shade() calculates the     บ
บ		  actual color at that point.  This may involve           บ
บ	       	  extra calls to trace for reflection and refraction.     บ
บ                                                                         บ
...
บ                                                                         บ
บ                  Requires: defs.h, extern.h,c onfig.h                   บ
บ                                                                         บ
...
void	Shade(level, weight, P, N, I, hit, col, ior)
	int	level;
	Flt	weight;
	Vec	P, N, I;
	Isect	*hit;
