...
บ                             Bob Ray Tracer                              บ
บ                                                                         บ
บ                    Shadow.C = shadow feeler routines			  บ
บ                                                                         บ
...
บ                                                                         บ
บ                  Requires: defs.h, extern.h, config.h                   บ
บ                                                                         บ
...
int     Shadow(ray, hit, tmax, color, level, cur_light, inside)
	Ray	*ray;
	Isect	*hit;
...
int     sShadow(ray, hit, tmax, color, level, cur_light, inside)
	Ray	*ray;
	Isect	*hit;
	Flt	tmax;		/* dist to light we are trying to hit */
	Color	color;		/* for colored shadows */
