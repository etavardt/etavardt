...
บ                             Bob Ray Tracer                              บ
บ                                                                         บ
บ                    Tri.C = the triangular patch primitive		  บ
บ                                                                         บ
